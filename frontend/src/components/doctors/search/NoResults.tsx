        ...
        <Container className={`${className} mt-3 h-main`}>
            ...
            <Row className="d-flex my-4 align-content-around text-center h-100">
                ...
                {(icon || subtitle) && <Container>
                    {icon && <Row className="pb-4"><Col><Icon icon={`${icon} huge-icon med-dark-grey`}/></Col></Row>}
                ...
                {(message || linkTitle) && <Container className="w-80">
                    ...
                    {linkTitle && <Row className="pt-2"><Col><a className="a-only-hover-decoration text-decoration-underline" href={linkTo} onClick={onClick}>{linkTitle}</a></Col></Row>}
                </Container>}
                <Row></Row>
            </Row>
        </Container>
